...
C     7: add END in typelist and lattice list
      ...
      CHARACTER*(*) FUNCTION APPOVWR(CS1,CS2)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C%%      write(*,*)'appovwr'
     ...
     +     'APPOVWR, attempt to overwrite beyond start')
      ...
      CHARACTER*(*) FUNCTION APPEND(CS1,CS2)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  APPEND
C@ AUTHORS    :  M.Vogt
C@ ARGS/IN    :  CS1,CS2 :    
...
C%%      write(*,*)'append'
      ...
      SUBROUTINE NEWEDGE(IELE,NENEW,NENEX,NSAME,IEDGE)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C%%      write(*,*)'newedge'
     ...
     +     'EdgeOut : ',CNAME(IEDGE(2)),' at TPL-index : ',IEDGE(2)
      ...
      SUBROUTINE RECEDGE(IELE,NENEW,NENEX,NSAME,IEDGE)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE WRMAD0(CSEQ0,CREF0,CSXPND,CSNAM0)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  WRMAD0
...
C            STXHLP = STXHLP*1.D+3
CCCCCCCCC  Fanglei Modified CCCCCCCCC
            STYHLP = STYHLP*1.D+3
         ENDIF
...
C=====from OPEN
 9993 CONTINUE
     ...
     +        ' while opening new slim-file')
      ...
      SUBROUTINE WRSLI0(CSLFM0,CSXPND)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  WRSLI0
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ COMMAND    :  
...
C=====lattice-list
     ...
     +              'SLATWR, '//CN(J)(:8)//' might be ambigous')
               ...
               IF(ITYPE(LT).EQ.ISO) THEN 
                  IPOS(J) = NINT((ENDPOS+PREDRF(LL))*DM2LP) 
               ELSE
                  IPOS(J) = NINT((ENDPOS+PREDRF(LL)+RL*0.5D+0)*DM2LP) 
               ENDIF
               ENDPOS = ENDPOS+PREDRF(LL)+RL
 ...
 1121       CONTINUE
            ...
            WRITE(IUSLIM,'(4(A8,I9,1X))')
     +           (CN(JW),IPOS(JW),JW=0,JS)
...
C%%      write(*,*)'numele'
 ...
 100  CONTINUE
      ...
      CHARACTER*(*) FUNCTION CNCHECK(CWORD,CFORM)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C========undo slicing
 ...
 100  CONTINUE
      ...
      SUBROUTINE COSYELE(IUFOXY,IELE,CNAMEI,RLENI,STRXI,STRYI)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C%%      write(*,*)'petrosbe'
     ...
     +     '2nd line','3rd line','4th line'
      ...
      SUBROUTINE PETROSELEOUT(IUPETROS,BPR)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C========undo slicing
 ...
 100  CONTINUE
      ...
      SUBROUTINE PETROSELE(IUPETROS,IELE,
...
*******************************************
     ...
     +        'make marker'
      ...
      SUBROUTINE PETROSLATOUT(IUPETROS)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C%%      write(*,*)'rdmad0'
 ...
 11   CONTINUE
     ...
     +     ' TOTAL LENGTH :         '        ,DRINGL
      ...
      SUBROUTINE PRSGEN(CBUF,IEB,BELL,BLAT)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  PRSGEN
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C=====OOPS!
      ...
      SUBROUTINE PRSELL(CBUF,IEB,BELL)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  PRSELL
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C-FUTURE-VOGTM-15.02.00   and DON'T initialize it in PRSELL !!!!!!!!!!!!!
 ...
 1000 CONTINUE
      ...
      SUBROUTINE PRSLAT(CBUF,IEB,BLAT)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  PRSLAT
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
Ctest<
     ...
     +        CDUM(:IEE)//' at '// CDDD)
      ...
      SUBROUTINE MADMRK(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADMRK
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C 10   CONTINUE
      ...
      SUBROUTINE MADDRF(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADDRF
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'maddrf'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADMON(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADMON
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'madmon'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADSBE(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,XN, *)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSBE
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADRBE(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,XN, *)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADRBE
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADQUA(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADQUA
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         SY = 0.D+0
      ...
      SUBROUTINE MADTMM(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADTMM
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C%%      write(*,*)'madtmm'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADSEX(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSEX
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADSOL(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSOL
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADKIX(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADKIX
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADKIY(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADKIY
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADCAV(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADCAV
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C         TW = 0.D+0
      ...
      SUBROUTINE MADSSN(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSSN
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C               TW  = 0.D+0
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADSPM(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSPM
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C%%      write(*,*)'madspm'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADASH(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADASH
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C%%      write(*,*)'madash'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADMAT(CBUF,IEB,ITP,SX,SY,RL,IS,TW,IFH,
     +     BSWOFF,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADMAT
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
C     default plane is vertical 
      ...
      SUBROUTINE MADSRM(CBUF,IEB,ITP,SX,SY,SZ,RL,IS,TW,K0,K1,
     +     IFH,BSWOFF,IPH,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADSRM
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
...
Ctest<
      ...
      SUBROUTINE EXTMAD(CBUF,ITYPE,IPS,ISL,IFL,SY,BXT)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  EXTMAD
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C=====unfortunately 'LINE' is an  a s s i g n m e n t  'LINE=(x,y,z,...)'
     ...
     +     'IKWELL, no LINEs supported yet')
      ...
      CHARACTER*2 FUNCTION CREGMR(BALPH,NNEW)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CREGMR
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE STRIP0(CLINE,IE,BCONT,*,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  STRIP0
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'strip0'
 ...
 10   CONTINUE
      ...
      SUBROUTINE STRIPX(CLINE,IE,BCONT,*,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  STRIPX
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C     RETURN : comment line 
C     RETURN : comment line in between continuation
C     !!! whole thing still in developement !!!
...
C%%      write(*,*)'stripx'
 ...
 10   CONTINUE
      ...
      SUBROUTINE STRIPC(CLINE,IE,BCONT,*,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  STRIPC
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'stripc'
      ...
      INTEGER FUNCTION IMADWD(CBUF,IEB)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  IMADWD
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'imadwd'
 ...
 10   CONTINUE
      ...
      SUBROUTINE MADWRD(CKW,IEK,CBUF,IEB,IW)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  MADWRD
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C      write(*,*) JW,' >',CKW(:IEK),'<'
      ...
      SUBROUTINE PRSASS(CW,IE1,CN,CV,BASS)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  PRSASS
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'prsass'
      ...
      SUBROUTINE STRIP(CIN,COUT,LOUT)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  STRIP
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'ibfcs'
 ...
 10   CONTINUE
      ...
      CHARACTER*31 FUNCTION CSFIB(IFL)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CSFIB
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'csfib'
 ...
 10   CONTINUE
      ...
      CHARACTER*(*) FUNCTION CFINFL(INUM,CBLANK)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CFINFL
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C     ! next is a g77 workaround !
     ...
     +     //CLDUM//' is not an integer')
      ...
      CHARACTER*(*) FUNCTION COMPOS(CLINE,IP)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  COMPOS
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'compos'
 ...
 10   CONTINUE
      ...
      CHARACTER*(*) FUNCTION CIFCL(CSTR,ILINE)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CIFCL
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'cifcl'
     ...
     +        ' is not enclosed in quotes')
      ...
      CHARACTER*(*) FUNCTION CPOS(CLINE,IPOS)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CPOS
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'cpos'
 ...
 40   CONTINUE
     ...
     +     CALL TOFF('CPOS, word too long')
      ...
      CHARACTER*(*) FUNCTION CASEUP(CLINE)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  CASEUP
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
C%%      write(*,*)'caseup'
 ...
 10   CONTINUE
      ...
      CHARACTER*(*) FUNCTION CASEDOWN(CLINE)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE BACKSTEP(IUNIT,CMARK,IMAX,IERR,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C%%      write(*,*)'backstep'
 ...
 9999 CONTINUE
      ...
      SUBROUTINE NEWVNR(FIN,MAXVNR,FOUT,IVNR,LOUT,IERR,*)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  NEWVNR
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      REAL*8 FUNCTION DIVI0(DNUMER,DENOMI)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C@ SUBPROGRAM :  DIVI0
C@ AUTHORS    :  G.H.Hoffstaetter, M.Vogt
C@ ARGS/IN    :     
