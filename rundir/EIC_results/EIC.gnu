...
reset
set terminal epslatex size 12cm,8cm color colortext standalone header \
...
plot [:][0:100] \
  ...
  "mctdep.out" u 2:(77.1549*($3/(2323.6492/60 +$3)))  title "M-C poln (total)"  w l lt 3
...
#set title "PLOT 36: EIC,RQ,0.3mrad 3s,coupl.res., standard SLICK (D.P. Barber)"
#plot [:][0:100] \
